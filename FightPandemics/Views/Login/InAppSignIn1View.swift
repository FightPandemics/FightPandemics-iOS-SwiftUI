// in-app-sign-in-1 SignIN
import SwiftUI

struct InAppSignIn1View: View {
...
{SignUpButton (backgroundColor: Color("purpleishBlue"),buttonText:"Continue with E-mail",foregroundColor: Color ("white"))}
        }
...
struct InAppSignIn1View_Preview: PreviewProvider {

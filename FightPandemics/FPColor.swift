...
// Abstract: Fight Pandemics Colors Catalog
struct FPColor {
...
>>>>>>> a40a1a2ba53487f58584592f57bccc99f026086a
    ...
    static let colorSecondaryBrandColor = Color("colorSecondaryBrandColor")
    static let colorSecondaryOffWhite = Color("colorSecondaryOffWhite")
...
struct FPColor_Previews: PreviewProvider {
